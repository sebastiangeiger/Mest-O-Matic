...
describe Submission do
  ...
  #   test not working, 
  #   sub = Submission.create(:solution => @solutionA, :archive => @zipFile)
  #   sub.should be_valid
  #   @solutionA.submissions << sub
  #   subb = Submission.create(:solution => @solutionA, :archive => @zipFile)
  #   subb.should_not be_valid
  # end
end
